<div class="popup-form" id="popup-form">
    ...
    <span>
        ...
        <button id="close-button"><svg width="24" viewBox="0 0 24 24" height="24" xmlns="http://www.w3.org/2000/svg">
    ...
    <form action="{{ route('discussion.addPost') }}" method="POST" enctype="multipart/form-data">
        ...
        <section class="popup-content">
            ...
            @if ($errors->any())
                @include('components.error-popup', ['error-message' => $errors->first()]);
            @endif
        </section>
